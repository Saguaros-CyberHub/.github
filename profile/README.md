...
In progress. An installation script will be provided to guide you through the setup of all required dependencies and modules. Will prompt you for cluster information, as well as administrator and database credentials, and generate the necessary keys.
...
- [x] Module registration and capability discovery
...
- [x] Crucible authentication via CyberCore
...
- [x] Lane reset and rebuild automation
...
CyberProbe provides automated fuzzing and vulnerability-discovery workflows designed to generate malformed inputs, detect failures, and identify security weaknesses.
